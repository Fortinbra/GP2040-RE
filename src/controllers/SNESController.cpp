...
const uint8_t SNES_BUTTON_A = 0x01;
const uint8_t SNES_BUTTON_B = 0x02;
const uint8_t SNES_BUTTON_X = 0x04;
const uint8_t SNES_BUTTON_Y = 0x08;
const uint8_t SNES_BUTTON_L = 0x10;
const uint8_t SNES_BUTTON_R = 0x20;
const uint8_t SNES_BUTTON_SELECT = 0x40;
const uint8_t SNES_BUTTON_START = 0x80;
const uint8_t SNES_BUTTON_UP = 0x100;
const uint8_t SNES_BUTTON_DOWN = 0x200;
const uint8_t SNES_BUTTON_LEFT = 0x400;
const uint8_t SNES_BUTTON_RIGHT = 0x800;
...
void SNESController::sendToSystem(uint16_t data)
{
